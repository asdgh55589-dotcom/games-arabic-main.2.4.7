...
export const metadata: Metadata = {
  ...
  description: 'حمّل أفضل التعريبات العربية للألعاب. مجتمع نشط من المترجمين واللاعبين. تعريبات احترافية عالية الجودة.',
  keywords: ['تعريب ألعاب', 'Games Arabic', 'العاب مترجمة', 'تعريبات', 'ترجمة ألعاب', 'ألعاب عربية'],
