      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, requiredMods: parseInt(e.target.value) || 0 })
            }
            className="w-full rounded-md border bg-background px-3 py-2 text-sm"
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, requiredDownloads: parseInt(e.target.value) || 0 })
            }
            className="w-full rounded-md border bg-background px-3 py-2 text-sm"
          />
        </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, requiredRating: parseFloat(e.target.value) || 0 })
            }
            className="w-full rounded-md border bg-background px-3 py-2 text-sm"
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, requiredQualityScore: parseFloat(e.target.value) || 0 })
            }
            className="w-full rounded-md border bg-background px-3 py-2 text-sm"
          />
        </div>
