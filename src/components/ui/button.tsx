...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-sm text-[12.5px] font-medium transition-colors duration-150 disabled:pointer-events-none disabled:opacity-45 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-3.5 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-white border border-primary-dark shadow-sm hover:bg-primary-dark",
        destructive:
          "bg-red text-white border border-red-dark shadow-sm hover:bg-red-dark",
        outline:
        ...
        ghost:
          "text-secondary-foreground hover:bg-background-secondary hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        success:
          "bg-green text-white border border-green-dark shadow-sm hover:bg-green-dark",
        warning:
          "bg-yellow text-white border border-yellow-dark shadow-sm hover:bg-yellow-dark",
      },
      size: {
