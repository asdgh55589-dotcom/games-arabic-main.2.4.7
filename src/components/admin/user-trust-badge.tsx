...
export function UserTrustBadge({ score, label = 'الثقة', showDetails = true }: Props) {
  ...
  const getColor = () => {
    if (score.score >= 70)
      return 'bg-green-100 text-green-800 border-green-300 hover:bg-green-200 dark:bg-green-900/30 dark:text-green-300 dark:border-green-700'
    if (score.score >= 40)
      return 'bg-yellow-100 text-yellow-800 border-yellow-300 hover:bg-yellow-200 dark:bg-yellow-900/30 dark:text-yellow-300 dark:border-yellow-700'
