...
CREATE TABLE "CreatorRequest" (
    ...
    "track" TEXT NOT NULL DEFAULT 'translator',
    "portfolioUrls" TEXT,
...
CREATE TABLE "Mod" (
    ...
    "featuredLevel" INTEGER,
    "featuredUntil" TIMESTAMP(3),
    "trendingUntil" TIMESTAMP(3),
    "popularUntil" TIMESTAMP(3),
    "hiddenBadges" TEXT NOT NULL DEFAULT '',
